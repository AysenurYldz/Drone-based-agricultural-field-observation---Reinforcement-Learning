...
def resimleri_yukle():
    ...
    resim_klasoru = "/content/drive/MyDrive/DPO_Odev/images"
    resimler = {
...
class AkilliDrone:
        ...
        for bolum in range(1, bolum_sayisi + 1):
            ...
            if bolum % 1000 == 0:
                ...
                if ortalama_basari > en_iyi_basari:
                    ...
                    self.model_kaydet(f"/content/drive/MyDrive/DPO_Odev/v13/en_iyi_drone_q_tablosu.pkl")
            ...
            # Ara model kaydet
            if bolum % 100000 == 0:
                self.model_kaydet(f"/content/drive/MyDrive/DPO_Odev/v13/drone_q_tablosu_{bolum}.pkl")
    ...
    def model_kaydet(self, dosya_adi="/content/drive/MyDrive/DPO_Odev/v13/drone_q_tablosu.pkl"):
        """Modeli kaydet"""
...
if __name__ == "__main__":
    ...
    try:
        ...
        model_dosyasi = "/content/drive/MyDrive/DPO_Odev/v13/drone_q_tablosu.pkl"
